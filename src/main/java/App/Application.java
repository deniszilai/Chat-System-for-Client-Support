...
public class Application
{
    ...
    private JPanel getLeftPanel()
    {
        ...
        leftPanel.add(getUsersPanel(), constraints1);
        leftPanel.add(getCommandsPanel(), constraints2);
    ...
    private JPanel getChatPanel()
    {
        ...
        addToChat("Welcome to the chat app!\n" +
                        "Login using the CONNECT button\n\n",
                ATTR_ITALIC);
    ...
    /**
     * Return the panel in which the connected usernames are displayed
     */
    ...
    /**
     * Return the panel in which the command buttons are available
     */
                                        ...
                                        JButton disconnectButton)
    {
        return e ->
        {
            ...
            if (name != null)
            {
                ...
                {
                    addToChat("[Server]: Connection error, " +
                            "name empty.", ATTR_ERROR);
                }
            }
        };
    }
